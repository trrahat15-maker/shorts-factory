...
- `VIRAL_MODE` (`true` or `false`, default: `true`, targets 15-25s shorts and fast cuts)
...
- `MAX_DURATION`
- `SCRIPT_DURATION_SECONDS` (default: `20` in viral mode)
- `MIN_DURATION` (minimum video length in seconds, default: `15` in viral mode)
